...
(function () {
  ...
  function ChatTab() {
    return React.createElement("div", { className: "flex items-center justify-center h-full p-4" },
      React.createElement("p", { className: "text-sm text-muted-foreground" }, "Chat tab will be fully implemented in the next iteration. Please use the Sessions tab for now.")
    );
  }
  ...
  // =========================================================================
  function WebUIPage() {
    var tabState = useState("sessions");
